...
public class AccountType implements java.io.Serializable {
    ...
    public static final java.lang.String _AUTO_LOAN = "AUTO_LOAN";
    public static final java.lang.String _STUDENT_LOAN = "STUDENT_LOAN";
    ...
    public static final AccountType CREDIT = new AccountType(_CREDIT);
    public static final AccountType AUTO_LOAN = new AccountType(_AUTO_LOAN);
    public static final AccountType STUDENT_LOAN = new AccountType(_STUDENT_LOAN);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ejb3.examples.itko.com/", "accountType"));
    }
    /**
