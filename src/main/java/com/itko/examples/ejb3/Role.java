...
public class Role implements java.io.Serializable {
    ...
    public static final Role GUEST = new Role(_GUEST);
    public static final Role REGULAR = new Role(_REGULAR);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ejb3.examples.itko.com/", "role"));
    }
    /**
